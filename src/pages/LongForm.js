...
const LongForm = () => {
  ...
  return (
    <div className='h-screen w-screen flex justify-center items-center overflow-auto'>
      <form
        className='shadow-lg p-10 border-2 border-l-red-400 border-r-yellow-300 border-t-blue-300 border-b-gray-500 rounded-md flex flex-wrap gap-3 max-w-3xl justify-between'
        onSubmit={submit}
      >
